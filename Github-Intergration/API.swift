...
public final class SearchTop10UsersQuery: GraphQLQuery {
  ...
  public let operationName: String = "SearchTop10Users"

  public var user: String
  public var count: Int

  public init(user: String, count: Int) {
    self.user = user
    self.count = count
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("search", arguments: ["query": GraphQLVariable("user"), "type": "USER", "first": GraphQLVariable("count")], type: .nonNull(.object(Search.selections))),
    ]
    ...
    public struct Search: GraphQLSelectionSet {
      ...
      public struct Node: GraphQLSelectionSet {
        ...
        public static func makeUser(name: String? = nil, login: String, avatarUrl: String, url: String, bio: String? = nil, id: GraphQLID, repositories: AsUser.Repository) -> Node {
          return Node(unsafeResultMap: ["__typename": "User", "name": name, "login": login, "avatarUrl": avatarUrl, "url": url, "bio": bio, "id": id, "repositories": repositories.resultMap])
        }
        ...
        public struct AsUser: GraphQLSelectionSet {
          ...
          public init(name: String? = nil, login: String, avatarUrl: String, url: String, bio: String? = nil, id: GraphQLID, repositories: Repository) {
            self.init(unsafeResultMap: ["__typename": "User", "name": name, "login": login, "avatarUrl": avatarUrl, "url": url, "bio": bio, "id": id, "repositories": repositories.resultMap])
          }
...
public final class SearchReposQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("user", arguments: ["login": GraphQLVariable("user")], type: .object(User.selections)),
    ]
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public static let selections: [GraphQLSelection] = [
        GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
        GraphQLField("repositories", arguments: ["first": GraphQLVariable("count"), "isFork": false], type: .nonNull(.object(Repository.selections))),
      ]
      ...
      public struct Repository: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public init(name: String, id: GraphQLID, url: String) {
            self.init(unsafeResultMap: ["__typename": "Repository", "name": name, "id": id, "url": url])
          }
